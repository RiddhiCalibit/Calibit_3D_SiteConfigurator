...
// // //   const handleExport = async (format: "json" | "pdf" | "dwg" | "excel" = "json") => {
// // //     const timestamp = new Date().getTime();
// // //     const exportDate = new Date().toLocaleDateString();
...
// // //         viewSnapshots?: Array<{ label: string; subtitle: string; dataUrl: string }>,
// // //       ) => {
// // //         const doc = new jsPDF({
// // //           orientation: "portrait",
// // //           unit: "mm",
...
// // //             const x = colX[col];
// // //             const y = startY + row * (labelH + subtitleH + cellH + rowPad);

// // //             // Section label
// // //             doc.setFontSize(8);
// // //             doc.setFont("helvetica", "bold");
// // //             doc.setTextColor(...teal);
// // //             doc.text(view.label.toUpperCase(), x, y + labelH - 1);

// // //             // Subtitle
// // //             doc.setFontSize(7);
// // //             doc.setFont("helvetica", "normal");
// // //             doc.setTextColor(120, 130, 140);
// // //             doc.text(view.subtitle, x, y + labelH + subtitleH - 2);

// // //             // Image with border
// // //             doc.setDrawColor(220, 225, 230);
// // //             doc.setLineWidth(0.3);
// // //             doc.rect(x, y + labelH + subtitleH, cellW, cellH);
// // //             try {
// // //               doc.addImage(view.dataUrl, "PNG", x, y + labelH + subtitleH, cellW, cellH);
// // //             } catch {
// // //               doc.setFontSize(7);
// // //               doc.setTextColor(160, 160, 160);
// // //               doc.text("View unavailable", x + 2, y + labelH + subtitleH + cellH / 2);
// // //             }
// // //           })
// // //         }
...
// // //           if (!canvas || canvas.width === 0) { resolve([]); return; }
...
// // //           const results: Array<{ label: string; subtitle: string; dataUrl: string }> = [];
...
// // //         };
// // //         img.onerror = () =>
// // //           generatePDF(undefined, viewSnapshots.length > 0 ? viewSnapshots : undefined);
// // //         img.src = staticMapUrl;
// // //       } else {
// // //         generatePDF(undefined, viewSnapshots.length > 0 ? viewSnapshots : undefined);
// // //       }
...
// //         doc.setFont("helvetica", "normal");
// //         doc.setTextColor(...dark);
// //         doc.text(`X = ${startPoint.x} m    Y = ${startPoint.y} m`, 55, y);
// //         y += 8;
